                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="rec_amnt" name="rec_amnt"
                                                            value="{{\App\Helpers\Helper::formatIndianNumber($data->rec_amnt)}}" readonly class="form-control">
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" value="{{\App\Helpers\Helper::formatIndianNumber($data->rec_intrst)}}" id="rec_intrst"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="settle_bal_loan_amnnt" readonly
                                                            name="settle_bal_loan_amnnt" value="{{\App\Helpers\Helper::formatIndianNumber($data->settle_bal_loan_amnnt)}}" required
                                                            class="form-control">
                                                    </div>
                                            ...
                                            <div class="col-md-3" hidden>
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input id="settle_intr_bal_amnnt" value="{{\App\Helpers\Helper::formatIndianNumber($data->settle_intr_bal_amnnt)}}" name="settle_intr_bal_amnnt" type="text"
                                            ...
                                            <div class="col-md-3 finalvalue">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" value="{{\App\Helpers\Helper::formatIndianNumber($data->settle_amnnt)}}" oninput="settle()"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="settle_wo_amnnt" name="settle_wo_amnnt"
                                                            readonly value="{{\App\Helpers\Helper::formatIndianNumber($data->settle_wo_amnnt)}}" class="form-control">
                                                    </div>
...
if (customerID != "") {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            let intrest = parseFloat($('#settle_intr_bal_amnnt').val()) || 0;
            if (data.customer_record.recovery_loan.length != 0) {
                ...
                totalRecovery = parseFloat(maxIdRecoveryLoan
                    .rec_principal_amnt);
                totalIntrestReceived = parseFloat(maxIdRecoveryLoan
                    .rec_interest_amnt);

            }
            totalRecovery = parseFloat(data.customer_record.recovery_loan_amount)||0;
            ...
            let settle_bal_loan_amnnt = data.customer_record.loan_appraisal
            ...
            $("#loan_amount").val(formatIndianNumber(data.customer_record.loan_appraisal
                .term_loan));
        ...
        $(document).on('input', '.principal-amnt', function() {
            ...
            var interestRate = parseFloat($('#data_interest').val());
        ...
        function checkDividedAmount() {
            let amount = parseFloat($('#settle_amnnt').val());
        ...
        function settle() {
            ...
            let settleAmount = parseFloat($('#settle_amnnt').val());
            let balanceLoanAmount = parseFloat($("#settle_bal_loan_amnnt").val());
