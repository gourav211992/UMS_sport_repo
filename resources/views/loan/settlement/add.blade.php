            ...
            if (customerID != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var totalIntrestReceived = parseFloat(data.customer_record.recovery_ia) || 0;
                        ...
                        let amount = data.customer_record.loan_appraisal.term_loan;
                        ...
                        {
                            $("#settle_bal_loan_amnnt").val(formatIndianNumber(settle_bal_loan_amnnt));
                        } else {
                            $("#settle_bal_loan_amnnt").val(settle_bal_loan_amnnt); // Already formatted
                        }
