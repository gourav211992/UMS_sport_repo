                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-select select2" multiple name="ledger_group_id[]" required>
                                                        @foreach ($groups as $group)
                                                            <option value="{{ $group->id }}" @if(old('ledger_group_id') && old('ledger_group_id') == $group->id) selected @endif>
                                                                {{ $group->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
