                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="date" class="form-control" id="date"
                                                            name="date" oninput="getDocNumberByBookId()" required
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-7">
                                                      <div class="d-flex align-items-center">
                                                           ...
                                                           <div class="col-md-4">
                                                               <div class="d-flex">
                                                                    <input type="text" class="form-control" readonly id="base_currency_code" style="text-transform:uppercase;width: 80px; border-right: none; border-radius: 7px 0 0 7px" />

                                                                    <input type="text" class="form-control" readonly id="orgExchangeRate" id="orgExchangeRate" style="width: 80px;  border-radius:0 7px 7px 0" />
                                                           ...
                                                           <div class="col-md-4">
                                                               <div class="d-flex">
                                                                    <input type="text" class="form-control" readonly id="company_currency_code" style="text-transform:uppercase;width: 80px; border-right: none; border-radius: 7px 0 0 7px" />

                                                                    <input type="text" class="form-control" readonly id="company_exchange_rate" style="width: 80px;  border-radius:0 7px 7px 0" />
                                                           ...
                                                           <div class="col-md-4">
                                                               <div class="d-flex">
                                                                    <input type="text" class="form-control" readonly id="grp_currency_code" style="text-transform:uppercase;width: 80px; border-right: none; border-radius: 7px 0 0 7px" />

                                                                    <input type="text" class="form-control" readonly id="grp_exchange_rate" style="width: 80px;  border-radius:0 7px 7px 0" />
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody class="mrntableselectexcel" id="item-details-body">
                                                            <tr id="1">
                                                                ...
                                                                <td>
                                                                    <select  required id="groupSelect1" name="parent_ledger_id[]"
                                                                ...
                                                                <input type="hidden" name="comp_credit_amt[]"
                                                                    ...
                                                                    <input type="hidden" class="dbt_amt_inr debt_inr_1" name="org_debit_amt[]" id="dept_inr_1" />
                                                                    <input type="hidden" class="crd_amt_inr crd_inr_1" name="org_credit_amt[]" id="crd_inr_1" />

                                                                <td><input type="number"
                                                                        class="form-control mw-100 dbt_amt debt_1 text-end"   onfocus="focusInput(this)"
                                                                        name="debit_amt[]" id="dept_1" min="0"
                                                                        value="0" /></td>

                                                                <td><input type="number"
                                                                        class="form-control mw-100 crd_amt crd_1 text-end"   onfocus="focusInput(this)"
                                                                        name="credit_amt[]" id="crd_1" min="0"
                                                                        value="0" /></td>
                                                                <td>
                                                                    <input type="text"
                                                                        class="form-control mw-100 centerselecct"
                                                                        placeholder="Select Cost Center"
                                                                        name="cost_center_name1" id="cost_center_name1"
                                                                        data-id="1" />
                                                                    <input type="hidden" name="cost_center_id1"
                                                                        type="hidden" id="cost_center_id1" />
                                                                </td>
                                                                <td>
                                                                    <input type="text"  class="form-control mw-100 remarks_" placeholder="Enter Remarks" id="hiddenRemarks_1"
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-md-4 mb-1">
                                                        ...
                                                        <input type="file" multiple onchange="checkFileTypeandSize(event)" class="form-control" name="document[]" id="document" />
    ...
    <script>
        ...
        */
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.add-item-row').addEventListener('click', function(e) {
                ...
                <tr id="${rowCount + 1}">
                                                                ...
                                                                <td><input type="number" 
                                                                        class="form-control mw-100 dbt_amt debt_${rowCount + 1} text-end" onfocus="focusInput(this)"
                                                                        name="debit_amt[]" id="dept_${rowCount + 1}" min="0"
                                                                        value="0" /></td>
                                                                <td><input type="number"
                                                                        class="form-control mw-100 crd_amt crd_${rowCount + 1} text-end" onfocus="focusInput(this)"
        ...
        function getBooks() {
            ...
            $.ajax({
                url: '{{ route('get_voucher_series', ['placeholder']) }}'.replace('placeholder', $('#book_type_id').val()),
                type: 'GET',
