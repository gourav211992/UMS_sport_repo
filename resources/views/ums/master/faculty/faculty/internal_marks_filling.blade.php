        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                <div class="form-group breadcrumb-right">
                    <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{ url('internal-marks') }}"><i data-feather="file-text"></i> Add Campus </a>
                    <a href="{{url('internal-marks-show')}}"  class="btn btn-primary btn-sm mb-50 mb-sm-0" > <i data-feather="check-circle" style="font-size: 40px;"></i>
