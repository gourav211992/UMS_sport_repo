...
<!-- BEGIN: Body-->
 @section('content')
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="#" onclick="deleteTimetable({{ $timetable->id }})">
    ...
    {{-- <script>
        ...
        var url = "{{url('faculty/timetable/delete-model-trim')}}"+"/"+slug;
    ...
    <script>
        function deleteTimetable(id) {
            if (confirm('Are you sure you want to delete this timetable?')) {
                fetch('/faculty/timetable/delete-model-trim/' + id, {
                    method: 'DELETE',
                    headers: {
                ...
                .then(response => {
                    if (response.ok) {
                        window.location.href = "{{ route('get-timetables') }}";  // Redirect after deletion
                    } else {
