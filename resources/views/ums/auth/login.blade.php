                    ...
                    <div class="login-box mt-2 min-Loginheight">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="loginArea">
                                    <form method="POST" action="{{route('post.ums.login')}}" id="myform">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="loginTabs">
                                                            ...
                                                            <div class="row my-4">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <a onclick="show_password();" class="eyebtn"><img src="{{asset('assets/admin/img/eye-inactive.svg')}}" /></a>
                                                                        @error('password')
                                                                        <div class="text-danger password_error">{{ $message }}</div>
                                                                        @enderror
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
            ...
            <div class="modal-content modal-filled bg-success">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <a href="" class="btn btn-light my-2">Continue</a>
                    </div>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
