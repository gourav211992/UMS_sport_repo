                     ...
                     <td class="tableactionnew">  
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{route('view_challenge_form',$scrutiny->id)}}" >
                                                                    <i data-feather="edit" class="me-50"></i>
                                                                    <span>View</span>
</a>
                                                                </button> 
                                                                <a class="dropdown-item"  onclick="return confirm('Are you sure?');" href="{{url('delete_challenge_form',$scrutiny->id)}}">
