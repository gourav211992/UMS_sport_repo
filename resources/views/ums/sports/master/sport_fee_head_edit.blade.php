            ...
            <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Fee Edit</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        <button type="submit" form="feeHeadEditForm" class="btn btn-primary btn-sm mb-50 mb-sm-0">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body customernewsection-form">
                                <form action="{{ route('sport_fee_head.update', $feeHead->id) }}" method="POST" id="feeHeadEditForm">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-8">
                                                <input type="text" name="fee_head" class="form-control" value="{{ old('fee_head', $feeHead->fee_head) }}">
                                                 </div>
                                                 ...
                                                 <div class="col-md-8">
                                                     <div class="form-check form-check-primary form-check-inline">
                                                         <input type="radio" id="status_active" name="status" class="form-check-input"
                                                           value="Active" {{ $feeHead->status == 'Active' ? 'checked' : '' }}>
                                                     ...
                                                     <div class="form-check form-check-primary form-check-inline">
                                                         <input type="radio" id="status_inactive" name="status" class="form-check-input"
                                                             value="Inactive" {{ $feeHead->status == 'Inactive' ? 'checked' : '' }}>
