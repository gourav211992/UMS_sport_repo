  <nav
        class="header-navbar navbar navbar-expand-lg align-items-center floating-nav d-block container-xxl erpnewheader">
            ...
            <div class="navbar-container d-flex content">
                <div class="bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav headerlogo">
                        <li><img src="../../../sports/assets/css/logo.jpg" /></li>
                    </ul>
                ...
                <ul class="nav navbar-nav align-items-center ms-auto">
                    <!-- <li class="nav-item d-none d-lg-block select-organization-menu">
                        <select class="form-select" disabled>
                            <option>Staqo World Pvt Ltd.</option>
                        </select>
                    </li> -->
                    ...
                    <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="dropdown-menu drop-newmenu dropdown-menu-end" aria-labelledby="dropdown-user">
                            <!-- <a class="dropdown-item" href="profile.html"><i class="me-50" data-feather="user"></i>
                                Profile</a>
                            <a class="dropdown-item" href="#"><i class="me-50" data-feather="tool"></i>
                                Change Pasword</a> -->
                            <a class="dropdown-item" href="{{route('sport.logout')}}"><i class="me-50" data-feather="power"></i>
                                Logout</a>
                        </div>
                    </li>
