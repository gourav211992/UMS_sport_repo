...
<td>
    ...
    <button type="button" class="btn btn-primary   px-25 font-small-2 py-25 editable-doc" data-bs-toggle="modal" data-bs-target="#docModal{{ $item->id }}">
        View Document
    </button>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered"> <!-- smaller width -->
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close  editable-doc" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
   ...
   <div class="modal-body text-center" style="max-height: 70vh; overflow-y: auto;">
    ...
    @endif
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary btn-sm px-25 font-small-2 py-25 pay-now-btn editable-doc" data-bs-dismiss="modal">
            Close
        </button>
      </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".editable-doc").prop('disabled',false);
