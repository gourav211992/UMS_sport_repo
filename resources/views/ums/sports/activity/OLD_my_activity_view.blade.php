...
@section('content')
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">{{ $data->activity }} Students</h2>
            ...
            <div class="content-body">
                <form id="form" name="form" action="{{ route('save-activity-details') }}" method="POST">
                    @csrf
                                                        ...
                                                        <tbody>
                                                            @foreach ($students as $index => $stu)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="students[{{ $stu->id }}][absence_reason]" 
    ...
    <select name="students[{{ $stu->id }}][activity_comment]" 
        ...
        <option value="Regularly attends and contributes to training sessions." @if(($data['activity_comment'] ?? '') === 'Regularly attends and contributes to training sessions.') selected @endif>Regularly attends and contributes to training sessions.</option>
                                                                    ...
                                                                    <td>
                                                                        <select name="students[{{ $stu->id }}][rating]" 
                                                                                class="form-select attendance-related attendance-{{ $stu->id }}">
                                                                            <option value="">Select</option>
                                                                            @for ($i = 5; $i >= 1; $i--)
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="students[{{ $stu->id }}][color]" 
                                                                               class="form-control attendance-related attendance-{{ $stu->id }}"
                                                                               value="{{ $data['color'] ?? '' }}">
                                                                    </td>
                                        
                                                                    <td>
                                                                        <input type="text" name="students[{{ $stu->id }}][remarks]" 
                                                                               class="form-control attendance-related attendance-{{ $stu->id }}"
                                                                               value="{{ $data['remarks'] ?? '' }}">
                                                                    </td>
                                                                </tr>
