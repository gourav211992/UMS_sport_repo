...
@section('content')
    ...
    $(document).ready(function () {
        $('#section').on('change', function () {
            ...
            if (sectionId) {
                $('#section-data').html('<tr><td colspan="6" class="text-center">Loading students...</td></tr>');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.length > 0) {
                            $.each(response, function (index, student) {
                                let matched = preselectedStudents.find(s => s.id == student.id);
                            ...
                            rows = `<tr><td colspan="6" class="text-center">No students found for this section.</td></tr>`;
                        }
                    ...
                    error: function (xhr) {
                        ...
                        $('#section-data').html('<tr><td colspan="6" class="text-danger text-center">Something went wrong</td></tr>');
                    }
                });
            } else {
                $('#section-data').html('');
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        $('#form-errors').html(`<div>Something went wrong with the request. Please try again.</div>`).show();
                    }
                }
            });
        });
