                                                            ...
                                                            <thead>
                                                                   ...
                                                                   <th width="30px">#</th>
                                                                    ...
                                                                    <th>
                                                                        <div class="form-check form-check-primary mt-25 custom-checkbox">
                                                                            <input type="checkbox" class="form-check-input mt-0" id="Present">
                                                                ...
                                                                <tbody class="">
                                                                     <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-check form-check-primary custom-checkbox">
                                                                                <input class="form-check-input" type="checkbox" id="Present1" checked>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td class="poprod-decpt"><strong>Reg001</strong></td>
                                                                        <td class="poprod-decpt">Aniket Singh</td>
                                                                        <td class="poprod-decpt">01-01-2025</td>
                                                                        <td>
                                                                            <div class="form-check form-check-primary custom-checkbox">
                                                                                <input class="form-check-input" type="checkbox" id="Present2" checked>
																				<label class="form-check-label" for="Present2">Manual</label>
                                                                            </div>
                                                                        </td>
                                                                        <td><select class="form-select mw-100">
                                                                          <option>Select</option>
                                                                        ...
                                                                        <td><span class="badge bg-danger badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		 <td><input type="text" class="form-control mw-100" /></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="poprod-decpt"><strong>Reg001</strong></td>
                                                                        <td class="poprod-decpt">Diksha Kumar</td>
                                                                        <td class="poprod-decpt">01-01-2025</td>
                                                                        <td>
                                                                        ...
                                                                        <td><span class="badge bg-secondary badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		<td><input type="text" class="form-control mw-100" /></td>
																	</tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="poprod-decpt"><strong>Reg001</strong></td>
                                                                        <td class="poprod-decpt">Abhay Sharma</td>
                                                                        <td class="poprod-decpt">01-01-2025</td>
                                                                        <td>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1">
                                                                        ...
                                                                        <td><span class="badge bg-primary badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		<td><input type="text" class="form-control mw-100" /></td>
																	</tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="badge bg-warning badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		<td><input type="text" class="form-control mw-100" /></td>
																	</tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="badge bg-info badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		<td><input type="text" class="form-control mw-100" /></td>
																	</tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="badge bg-success badgeborder-radius p-25">&nbsp;</span>                                                                        
                                                                        </td>
																		<td><input type="text" class="form-control mw-100" /></td>
																	</tr> 
