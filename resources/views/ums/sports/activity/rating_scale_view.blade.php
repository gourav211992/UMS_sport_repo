                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="newheader border-bottom mb-2 pb-25">
                                                    ...
                                                    <p class="card-text">ReadOnly the details</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input name="scores" type="text" class="form-control" value="{{ old('scores', $scalesData->scores) }}" disabled />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input name="remarks" type="text" class="form-control" value="{{ old('remarks', $scalesData->remarks) }}" disabled />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="demo-inline-spacing">
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="customColorRadio3" name="status" class="form-check-input" value="active" {{ $scalesData->status == 'active' ? 'checked' : '' }} disabled>
                                                            ...
                                                            <div class="form-check form-check-primary mt-25 me-0">
                                                                <input type="radio" id="customColorRadio4" name="status" class="form-check-input" value="inactive" {{ $scalesData->status == 'inactive' ? 'checked' : '' }} disabled>
