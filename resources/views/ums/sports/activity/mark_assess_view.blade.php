                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-2 mb-1 mb-sm-0">
                                                        <select class="form-select select2" name="batch_name" id="batch_name" disabled>
                                                            <option value="">Select</option>
                                                            <option value="batch1" selected>Batch 1</option>
                                                            <option value="batch2">Batch 2</option>
                                                            <!-- Other options -->
                                                        </select>
                                                        <!-- Hidden input to submit value -->
                                                        <input type="hidden" name="batch_name" value="batch1">
                                                    ...
                                                    <!-- <div class="col-md-2 mb-1 mb-sm-0">
                                                        <select class="form-select select2" 
                                                            name="batch_name"id="batch_name" disabled>
                                                            <option value="">Select</option>
                                                        </select>
                                                        @error('batch_name')
                                                            <div class="text-danger">{{ $message }}</div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-select select2" id="section_name" disabled
                                                            name="section_name">
                                                            <option value="">Select</option>
                                                        </select>
                                                        @error('section_name')
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-select select2" id="group_name" disabled
                                                            name="group_name">
                                                            <option value="">Select</option>
                                                        </select>
                                                        @error('group_name')
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-select select2" id="player_name" disabled
                                                            name="player_name">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-select select2" id="trainer" disabled
                                                            name="trainer">
                                                            <option value="">Select</option>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-select select2" id="screening_name" disabled
                                                            name="screening_name">
                                                            <option value="">Select</option>
                                                            ...
                                                            <tbody class="" id="screeniningDetails"
                                                                ...
                                                                @foreach ($sel_parameter_values as $param)
                                                                    <tr>
                                                                        ...
                                                                        <td><select class="form-select mw-100" disabled
                    ...
                    if (response.length > 0) {
                        ...
                        if (response.length > 0) {
                            $.each(response, function(index, param) {
                                ...
                                <td><input type="text" disabled name="response${index + 1}"  id="response${index + 1}"  class="form-control mw-100" placeholder="Enter Response"></td>
                                <td><input type="text" disabled name="comment${index + 1}" id="comment${index + 1}"  class="form-control mw-100" placeholder="Enter Comments"></td>
                                <td><select class="form-select mw-100" disabled name="rating${index + 1}"  id="rating${index + 1}">
                                <option value="">Select</option>
