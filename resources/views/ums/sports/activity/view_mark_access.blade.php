                                                            ...
                                                            <thead>
                                                                ...
                                                                <tbody class="">
                                                                     <tr>
                                                                        ...
                                                                        <td>
																			<input type="text" class="form-control mw-100" placeholder="Enter Response" readonly />
																		</td>
                                                                        <td><input type="text" class="form-control mw-100" placeholder="Enter Comments" readonly /></td>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td><input type="text" class="form-control mw-100" placeholder="Enter Response" readonly /></td>
                                                                        <td><input type="text" class="form-control mw-100" placeholder="Enter Comments" readonly /></td>
                                                                        <td><select class="form-select mw-100">
                                                                          <option>Select</option>
                                                                          <option>5</option>
