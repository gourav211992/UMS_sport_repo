                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="semester_code" class="form-control" value="{{ old('semester_code', $semester->semester_code) }}">
                                                    @error('semester_code')
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="enrollment_no" class="form-control" value="{{ old('enrollment_no', $semester->enrollment_no) }}">
                                                    @error('enrollment_no')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" name="seq_no" class="form-control" value="{{ old('seq_no', $semester->seq_no) }}">
                                                    @error('seq_no')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="radio" id="status_active" name="status" class="form-check-input" value="1"
                                                                {{ old('status', $semester->status) == '1' ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 me-0">
                                                            <input type="radio" id="status_inactive" name="status" class="form-check-input" value="0"
                                                                {{ old('status', $semester->status) == '0' ? 'checked' : '' }}>
