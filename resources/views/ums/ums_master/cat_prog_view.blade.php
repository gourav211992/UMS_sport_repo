...
@section('content')
    <form action="{{ route('cat-prog-doc.view', $categoryProgDoc->id) }}" method="GET">
        @csrf
        {{-- @method('GET') --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Document Category <span
                                                        ...
                                                        <select class="form-select" name="document_category_id" required>
                                                            @foreach ($documents as $document)
                                                                <option value="{{ $document->id }}"
                                                                    {{ $categoryProgDoc->document_category_id == $document->id ? 'selected' : '' }}>
                                                        ...
                                                        <select class="form-select" name="course_id" required>
                                                            @foreach ($courses as $course)
                                                                <option value="{{ $course->id }}"
                                                                    {{ $categoryProgDoc->course_id == $course->id ? 'selected' : '' }}>
                                                                    {{ $course->course_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Cat. Programe Doc Code <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="cat_prog_doc_code"
                                                            value="{{ $categoryProgDoc->cat_prog_doc_code }}" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Cat. Programe Doc Name <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="cat_prog_doc_name"
                                                            value="{{ $categoryProgDoc->cat_prog_doc_name }}" required />
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="customColorRadio3" name="status"
                                                                    ...
                                                                    {{ $categoryProgDoc->status == 'Active' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check form-check-primary mt-25 me-0">
                                                                <input type="radio" id="customColorRadio4" name="status"
                                                                    ...
                                                                    {{ $categoryProgDoc->status == 'Inactive' ? 'checked' : '' }}>
                                                                <label class="form-check-label fw-bolder"
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($documentDetails as $index => $documentDetail)
                                                                    <tr>
                                                                        <td>{{ $index + 1 }}</td>
                                                                        <td><strong>{{ $docs[$index] ?? 'Unknown' }}</strong>
                                                                        </td>
                                                                        <td>
                                                                            <select
                                                                                name="document_details[{{ $index }}][required]"
                                                                                class="form-select document-required"
                                                                                data-index="{{ $index }}">
                                                                                <option value="">Select</option>
                                                                                <option value="Yes"
                                                                                    {{ isset($documentDetail['required']) && $documentDetail['required'] == 'Yes' ? 'selected' : '' }}>
                                                                                    Yes</option>
                                                                                <option value="No"
                                                                                    {{ isset($documentDetail['required']) && $documentDetail['required'] == 'No' ? 'selected' : '' }}>
                                                                                    No</option>
                                                                            </select>
                                                                        </td>
                                                                        <td>
                                                                            <div class="demo-inline-spacing">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label class="form-check-label"
                                                                                        for="photocopy_{{ $index }}">Photocopy</label>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
