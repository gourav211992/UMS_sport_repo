									...
									<div class="row">
										<div class="col-md-12">
											<div class="newheader border-bottom mb-2 pb-25">
												<h4 class="card-title text-theme">View Institute</h4>
												<p class="card-text">Details are displayed below</p>
											</div>
										</div>
										...
										<div class="col-md-8">
											...
											<div class="row align-items-center mb-1">
												...
												<div class="col-md-5">
													<select class="form-select select2" name="affiliate_id" disabled>
														<option value="">Select</option>
														@foreach ($affiliates as $affiliate)
															<option value="{{ $affiliate->id }}"
																{{ $institute->affiliate_id == $affiliate->id ? 'selected' : '' }}>
											...
											<div class="row align-items-center mb-1">
												...
												<div class="col-md-5">
													<input type="text" class="form-control" name="institute_name" value="{{ $institute->institute_name }}" disabled>
												</div>
											</div>
											...
											<div class="row align-items-center mb-1">
												...
												<div class="col-md-5">
													<input type="text" class="form-control" name="enroll_no_code" value="{{ $institute->enroll_no_code }}" disabled>
												</div>
											</div>
										</div>
													...
													<div class="demo-inline-spacing">
														@foreach(['Active', 'Inactive'] as $statusOption)
															<div class="form-check form-check-primary mt-25">
																<input type="radio" id="status_{{ $statusOption }}" name="status" value="{{ $statusOption }}" class="form-check-input" disabled
																	{{ $institute->status == $statusOption ? 'checked' : '' }}>
