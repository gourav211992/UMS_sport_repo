                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="newheader border-bottom mb-2 pb-25"> 
                                                ...
                                                <p class="card-text">Details are shown below</p> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="text" class="form-control" value="{{ $year->academic_code }}" readonly>
                                                </div> 
                                            </div> 
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="text" class="form-control" value="{{ $year->academic_year }}" readonly>
                                                </div> 
                                            </div>  
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="date" class="form-control" value="{{ $year->start_date }}" readonly>
                                                </div> 
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="date" class="form-control" value="{{ $year->end_date }}" readonly>
                                                </div> 
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="text" class="form-control" value="{{ $year->enrollment_no }}" readonly>
                                                </div> 
                                            </div> 
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5"> 
                                                    <input type="number" class="form-control" value="{{ $year->sequence_no }}" readonly>
                                                </div> 
                                            </div> 
                                        </div> 
                                                ...
                                                <div class="col-md-12"> 
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="radio" class="form-check-input" {{ $year->status == 'Open' ? 'checked' : '' }} disabled>
                                                            <label class="form-check-label fw-bolder">Open</label>
                                                        </div> 
                                                        <div class="form-check form-check-primary mt-25 me-0">
                                                            <input type="radio" class="form-check-input" {{ $year->status == 'Closed' ? 'checked' : '' }} disabled>
                                                            <label class="form-check-label fw-bolder">Closed</label>
                                                        </div> 
                                                    </div> 
                                                </div> 
                                            </div> 
