                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select select2 @error('program_id') is-invalid @enderror" name="program_id">
                                                            @foreach ($program as $item)
                                                                <option value="{{ $item->id }}" {{ old('program_id', $course->program_id) == $item->id ? 'selected' : '' }}>
                                                                    {{ $item->program_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control @error('course_code') is-invalid @enderror" name="course_code"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control @error('enrollment_no') is-invalid @enderror" name="enrollment_no"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control @error('sequence_no') is-invalid @enderror" name="sequence_no"
