			...
			<div class="ed-mm-right">
				<div class="ed-mm-menu">
					...
					<!--<div class="ed-mm-inn mob-menudeta">
						...
						<h4 class="pb-2 border-bottom mb-2"><a href="{{url('student-login')}}">Student Login</a></h4>
					</div>-->
				</div>
			</div>
		</div>
...
<section>
    ...
    <section>
        <!-- LOGIN SECTION -->
		@include('ums.frontend.layouts.partials.login-page-modal')
		@include('ums.frontend.layouts.partials.register-page-modal')
        ...
        <div id="modal3" class="modal fade" role="dialog">
            <div class="log-in-pop">
                <div class="log-in-pop-right">
					...
					<form class="row" method="POST" action="{{ url('forgot-password') }}" id="myform_forgot">
					@csrf
                        <div>
			...
			<div class="modal-content modal-filled bg-success">
				<div class="modal-body p-4">
					<div class="text-center">
						...
						<a href="{{route('user.dashboard')}}" class="btn btn-info my-2">Continue</a>
						@else
						<a href="{{url()->current()}}" class="btn btn-info my-2">Continue</a>
						@endif
					</div>
