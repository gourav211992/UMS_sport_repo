...
<section>
	<div class="container com-sp pad-bot-70 pg-inn pt-3">
		<div class="n-form-com admiss-form">
			...
			<form method="POST" action="{{ route('application-form') }}" id="myform_application" enctype="multipart/form-data" autocomplete="off">
				@csrf
				<div class="invalid-feedback text-danger error_application"></div>

				<div class="row">
					<div class="col-md-12 mb-2">
						<label for="">Application For <span class="text-danger">(Please click the correct box)</span></label>
						<p class="newboxciradio">
							<input type="radio" class="filled-in application_for" name="application_for" value="1" id="applicatio_for1" @if($course_single==null || $course_single->campus_id==1) checked @endif>
							<label for="applicatio_for1" class="form-check-label"><strong>IN DSMNRU CAMPUS</strong><span class="text-danger">*</span></label>

							<input type="radio" class="filled-in application_for" name="application_for" value="2" id="applicatio_for2" @if($course_single && $course_single->campus_id>1) checked @endif>
							<label for="applicatio_for2" class="form-check-label"><strong>AFFILIATED COLLEGE</strong><span class="text-danger">*</span> <i class="text-danger">(Admissions are subject to the approval of the program from RCI and affiliation by DSMNRU)</i></label>
					...
					<div class="row college_name">
						<div class="col-md-4 mb-5">
								...
								<select class="form-control" name="campus_id" id="campus_id">
									...
									<option value="{{$college->id}}" @if($course_single && $course_single->campus_id==$college->id) selected @endif>{{$college->name}}</option>
									@endforeach
								</select>
				...
				<div class="row mb-5">
					...
					<div class="col-md-4">
						...
						<select class="form-control" name="course_type" id="course_type">
							...
							<option value="{{$programm_type->id}}" @if($programm_type_id==$programm_type->id) selected @endif >{{$programm_type->name}}</option>
							@endforeach
						</select>
					...
					<div class="col-md-4" id="hidelateral_entry" style="display: none;">
						...
						<select class="form-control" name="lateral_entry" id="lateral_entry" onchange="checkLeteralCourse()">
					...
					@include('frontend.index.application-course-preference')
				</div>
				...
				<div class="row mb-2">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control uppercase" name="student_first_Name" value="{{Auth::user()->first_name}}" maxlength="20" required readonly />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control uppercase" name="student_middle_Name" value="{{Auth::user()->middle_name}}" maxlength="20" readonly />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control uppercase" name="student_last_Name" value="{{Auth::user()->last_name}}" maxlength="20" readonly />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="date" class="form-control" name="date_of_birth" max="{{$max_dob}}" />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="email" class="form-control" name="student_email" value="{{Auth::user()->email}}" readonly />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control numbersOnly" name="student_mobile" maxlength="10" value="{{Auth::user()->mobile}}" readonly />
				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<h5 class="front-form-head no-bg pl-0 font-weight-bold"> Father's Name<span class="text-danger">*</span></h5>
						<input type="text" class="form-control uppercase" name="father_name" maxlength="30" autocomplete="__away"/>
						<div class="invalid-feedback text-danger father_name_application"></div>
					</div>
					<div class="col-md-6">
						<h5 class="front-form-head no-bg pl-0 font-weight-bold"> Father's Mobile Number<span class="text-danger">*</span></h5>
						<input type="text" class="form-control numbersOnly" name="father_mobile" maxlength="10" autocomplete="__away"/>
				...
				<div class="row mb-2">
					...
					<div class="col-md-6">
						<h5 class="front-form-head no-bg pl-0 font-weight-bold"> Mother's Name<span class="text-danger">*</span></h5>
						<input type="text" class="form-control uppercase" name="mother_name" maxlength="30" autocomplete="__away"/>
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control numbersOnly" name="mother_mobile" maxlength="10" autocomplete="__away"/>
				...
				<div class="row mb-5">
					...
					<div class="col-md-4 mb-2">
						...
						<input type="text" class="filled-in" name="religion" value="" id="religion2" autocomplete="__away" hidden>
					...
					<div class="col-md-4 mb-2" id="nationality11" hidden>
						<div class="form-group">
							<input type="text" class="form-control" name="nationality" value="Indian" value="In" id="nationality_value" autocomplete="__away"/>
							<div class="invalid-feedback text-danger nationality_application"></div>
						</div>
					</div>
					<div class="clearfix"></div>
					...
					<div class="col-md-4 mb-2">
						...
						<input type="text" class="filled-in" name="domicile" id="domicile2" autocomplete="__away" hidden>
						<div class="invalid-feedback text-danger domicile_application"></div>
						<input type="file" class="form-control" name="domicile_cirtificate" value="" id="domicile_cirtificate2" autocomplete="__away" hidden accept="image/*">
					...
					<div class="col-md-4 mb-2" id="enrollment11" hidden>
						<div class="form-group">
							<input type="text" class="form-control" name="enrollment_number" id="enrollment_value" autocomplete="__away"/>
					...
					<div class="col-md-4 mb-2">
							<input type="text" name="adhar_card_number" class="form-control numbersOnly" maxlength="12" />
							<div class="invalid-feedback text-danger adhar_card_number_application"></div>
					</div>
				
					<div class="col-md-12">
						<h5 class="front-form-head">Category <code>(File can be uploaded only in JPG,PNG or PDF format from 200KB to 500KB)</code></h5>
					</div>
					<div class="col-md-12">
					<div class="col-md-2 mb-2">
						<div class="form-group">
					...
					<div class="col-md-4 mb-2 certificate_no_text" id="certificate_no3" style="display:none;">
						<div class="form-group">
							<input type="file" class="form-control" name="upload_caste_certificate" accept="image/*" autocomplete="__away" maxlength="15" />
					...
					<div class="col-md-4 mb-2">
						<input type="text" class="form-control" name="ward_emp_name" autocomplete="__away" />
					...
					<div class="col-md-4 mb-2">
						<input type="text" class="form-control" name="ward_emp_relation" autocomplete="__away" />
					...
					<div class="col-md-4 mb-2 disability_category_box" hidden>
						<select class="form-control " id="disability_category" name="disability_category" onChange="change_disability_category($(this).val())">
							<option value="">--Select Option--</option>
							@foreach($disabilities as $disability )
								@if($disability->short_name!='NA')
								<option value="{{$disability->disability_category}}-{{$disability->short_name}}">{{$disability->disability_category}}-{{$disability->short_name}}  </option>
								@endif
							@endforeach
						</select>
					...
					<div class="col-md-2 mb-2 disability_certificate_no_text" id="certificate_no1" style="display:none;">
						<div class="form-group">
							<label>Percentage of Disability<span class="text-danger">*</span></label>
						</div>
					</div>

					<div class="col-md-4 mb-2 disability_certificate_no_text" id="" style="display:none;">
						<div class="form-group">
							<input type="text" class="form-control numbersOnly percentage_type" placeholder="%" name="percentage_of_disability" maxlength="5" autocomplete="__away" maxlength="18" />
					...
					<div class="col-md-4 mb-2 disability_certificate_no_text" id="certificate_no" style="display:none;">
						<div class="form-group">
					...
					<div class="col-md-2 mb-2 disability_certificate_no_text" id="certificate_no3" style="display:none;">
						<div class="form-group">
							<label>Upload Disability Certificate<span class="text-danger">*</span></label>
						</div>
					</div>

					<div class="col-md-4 mb-2 disability_certificate_no_text" id="certificate_no3" style="display:none;">
						<div class="form-group">
					...
					<div class="col-md-4 mb-2" id="freedom_fighter_dependent11" hidden>
						<div class="form-group">
							<input type="file" class="form-control" name="freedom_fighter_dependent_file" accept="image/*" id="freedom_fighter_dependent_value" autocomplete="__away"/>
							<div class="invalid-feedback text-danger freedom_fighter_dependent_file_application"></div>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="col-md-2 mb-2">
					...
					<div class="col-md-4 mb-2" id="ncc_cirtificate11" hidden>
						<div class="form-group">
							<input type="file" class="form-control" name="ncc_cirtificate" accept="image/*" id="ncc_cirtificate_value" autocomplete="__away"/>
					...
					<div class="col-md-4 mb-2" id="nss_cirtificate11" hidden>
						<div class="form-group">
							<input type="file" class="form-control" name="nss_cirtificate" accept="image/*" id="nss_cirtificate_value" autocomplete="__away"/>
					...
					<div class="col-md-4 mb-2" id="sportt_cirtificate11" hidden>
						<div class="form-group">
							<input type="file" class="form-control" name="sportt_cirtificate"  id="sportt_cirtificate1_value" accept="image/*" autocomplete="__away"/>
					...
					<div class="col-md-2 mb-2" id="hostal_options1" hidden>
						<div class="form-group">
							<label>How many years staying in DSMNRU Hostel<span class="text-danger">*</span></label>
						</div>
					</div>
					<div class="col-md-4 mb-2" id="hostal_options11" hidden>
						<div class="form-group">
							<input type="text" class="form-control numbersOnly" name="hostel_for_years" maxlength="2" id="hostel_distence1_value" autocomplete="__away"/>
					...
					<div class="col-md-2 mb-2" id="hostel_distence1" hidden>
						<div class="form-group">
							<label>Distance from your residence to University campus<span class="text-danger">*</span></label>
						</div>
					</div>
					<div class="col-md-4 mb-2" id="hostel_distence11" hidden>
						<div class="form-group">
							<input type="text" class="form-control numbersOnly placeholder_right" placeholder="KM" name="distance_from_university" maxlength="5"  id="hostel_distence1_value" autocomplete="__away"/> 
					...
					<div class="col-md-4">
						<div class="form-group">
							<input type="text" class="form-control" name="aiot_score" id="aiot_score" autocomplete="__away" />
					...
					<div class="col-md-4">
						<div class="form-group">
							<input type="text" class="form-control" name="aiot_rank" id="aiot_rank" autocomplete="__away" />
					...
					<div class="row mb-5" id="ded">
						<div class="col-md-2 mb-2" id="">
							<div class="form-group">
								...
								<span class="text-danger f-12 normal-line-height">(Uploaded doc should not be more than 100KB and only Image or PDF format accepted)</span>
								</label>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
							<input type="file" class="form-control" name="aiot_score_card" accept="image/*,application/pdf">
				...
				<div class="row mb-5" id="admission_applying_through">
					...
					<div class="col-md-4 jee jeee_roll_number_class">
						<div class="form-group">
							<input type="text" class="form-control" name="jeee_roll_number" id="jeee_roll_number" autocomplete="__away" />
					...
					<div class="col-md-4 jee" >
						<div class="form-group">
							<input type="date" class="form-control" name="jeee_date_of_examination" id="jeee_date_of_examination" autocomplete="__away" />
					...
					<div class="col-md-4 jee">
						<div class="form-group">
							<input type="text" class="form-control" name="jeee_score" id="jeee_score" autocomplete="__away" />
					...
					<div class="col-md-4 jee">
						<div class="form-group">
							<input type="text" class="form-control" name="jeee_rank" id="jeee_rank" autocomplete="__away" />
				...
				@include('frontend.index.application-form.address')
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">	
							@include('frontend.index.application-form.educational-qualification')
							<button type="button" class="btn btn-primary" onclick="addNewEducation($(this))">Click here to add more degrees <i class="fa fa-plus-square"></i></button>
							<br/>
							<br/>
						</div>
						@include('frontend.index.application-form.cuet-details')

						<div class="table-responsive">
							<table class="table table-bordered uploadtable">
								<tr>
									<td colspan="2"><b>Upload Photo and Signature <span class="text-danger">*</span></b>
										<br />
										<span class="text-danger f-12 normal-line-height">(Upload only JPG/PNG file upto 50 KB.)</span>
									</td>
								</tr>
								<tr>
						...
						<div>
							<p class="mt-4">
								...
								<label for="agree1" class="form-check-label"><strong>I Agree</strong><strong class="text-danger"> * </strong></label>
