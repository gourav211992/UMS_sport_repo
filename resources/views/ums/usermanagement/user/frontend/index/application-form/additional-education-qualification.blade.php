...
<section>
	<div class="container com-sp pad-bot-70 pg-inn pt-3">
		<div class="n-form-com admiss-form">
			...
			<div class="row">
				<div class="col-md-12">
					<h2 class="mt-0 mb-3 mobileadmintxt">Additional Qualification Form</h2>
					<hr />
				</div>
			</div>
			<form method="POST" action="{{url('additional-education-save')}}"  enctype="multipart/form-data" autocomplete="off">
				@csrf
				...
				<div class="row">
					...
					<!--<p style="color: red;">If any other certificate has been uploaded instead of domicile certificate, then it can be changed. </p>
					<div class="col-md-2 mb-2">
						<div class="form-group">
							<label>Domicile cirtificate<span class="text-danger">*</span></label>
					...
					<div class="col-md-4 mb-2">
						<input type="file" class="filled-in" name="domicile_cirtificate" id="domicile2" autocomplete="__away" hidden>
						<div class="invalid-feedback text-danger domicile_cirtificate"></div>
						<div class="invalid-feedback text-danger domicile_cirtificate"></div>
					</div>-->
					</div>
					<br /> 
