        ...
        <div class="row">
            <div class="col-md-12">
                <div class="containerBox">
                    ...
                    @include('ums.partials.notifications')

                    <div class="row">
                        <div class="col-md-5">
                            <div class="row dsmnruaction">
                                <div class="col-md-3 col-4 text-center">
                                    <a href="{{route('ums.login')}}">
                                        <div class="curve-box">
                                            <div class="head-img">
                                ...
                                <div class="col-md-3 col-4 text-center">
                                    <a href="{{route('sports.login')}}" target="_blank">
                                        <div class="curve-box" >
                                            <div class="head-img">
                                                {{-- <img src="{{asset('assets/frontend/css/landing/grievance1.png')}}" alt="" > --}}
                                                <img src="{{asset('sports/assets/css/logo.jpg')}}" alt="" >
                                                {{-- sports/assets/css/logo.jpg --}}
                                            </div>
                                            <p>Sports</p>
                                        </div>
                                    </a>
