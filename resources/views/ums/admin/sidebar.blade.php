...
<ul class="menu-content">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="{{url('activity-scheduler')}}"><i
                                ...
                                <li><a class="d-flex align-items-center" href="{{ url('my-activity') }}"><i
                        data-feather="circle"></i><span class="menu-item text-truncate">My Activity</span></a> </li>

                    <li><a class="d-flex align-items-center" href="{{ url('player-review') }}"><i
                        data-feather="circle"></i><span class="menu-item text-truncate">Player Review</span></a> </li>
 ...
 <li class="nav-item"><a class="d-flex align-items-center" href="index.html"><i
        ...
        <li class="nav-item"><a class="d-flex align-items-center" href=""><svg
                    ...
                    <span class="menu-title text-truncate">Ums Management
                    </span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('all_enrollment') }}"><i
                       data-feather="circle"></i><span class="menu-item text-truncate">Affiliate</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('nirf_report') }}"><i
                      data-feather="circle"></i><span class="menu-item text-truncate">Institute Mapping</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('nirf_report') }}"><i
                      data-feather="circle"></i><span class="menu-item text-truncate">Acadmic Year</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('nirf_report') }}"><i
                      data-feather="circle"></i><span class="menu-item text-truncate">Institute Mapping</span></a>
                    </li>
        ...
        <li class="nav-item has-sub menu-collapsed-open " style=""><a class="d-flex align-items-center" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg><span class="menu-title text-truncate" data-i18n="Dashboards">Master Management</span></a>
                    <ul class="menu-content" style=""> 
                        <li><a class="d-flex align-items-center" href="{{ url('affiliate') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Affliate</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('institute') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Institute Mapping</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('academic') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Academic Year</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('program_master') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Program Type</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('course') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Course</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('program-branch') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Program Branch</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('college') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">College Mapping</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('semesters') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Semester</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('document') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Document</span></a></li> 
                        <li><a class="d-flex align-items-center" href="{{ url('cat_prog') }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Category Programe Doc.</span></a></li> 
                        <li><a class="d-flex align-items-center" href="catgeory.html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Category</span></a></li> 
                        <li><a class="d-flex align-items-center" href="qualif.html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Qualification</span></a></li> 
                        <li><a class="d-flex align-items-center" href="qual-course.html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Qualification Course</span></a></li> 
                        <li><a class="d-flex align-items-center" href="quota.html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span class="menu-item text-truncate">Quota</span></a></li> 
                    </ul>
                </li>
                {{--ums master end--}}
