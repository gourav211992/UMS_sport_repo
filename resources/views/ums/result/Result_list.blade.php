            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-12 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right d-flex flex-wrap justify-content-start">
                        ...
                        <a href="{{url('semester_result_bulk')}}" class="btn btn-warning btn-md mt-1 mb-1 me-1">
                            Reset Bulk Download
                        </a>
                        <a href="{{url('nursing_result_bulk')}}" class="btn btn-primary btn-md mt-1 mb-1 me-2">
                    ...
                    <div class="form-group breadcrumb-right d-flex flex-wrap justify-content-start">
                        ...
                        <a href="{{url('internal_submit')}}" class="btn btn-warning btn-md mt-1 mb-1 me-2">
                                                    ...
                                                    <td class="tableactionnew">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <!-- Edit Record Link -->
                                                                <a class="dropdown-item" target="_blank"
                                                                    href="{{ url('edit_result') }}/{{ $result->roll_no }}?semester={{ $result->semester }}">
                                                                ...
                                                                <!-- Update CGPA Link -->
                                                                <a class="dropdown-item" target="_blank"
                                                                    href="{{ url('cgpa_update') }}?roll_no={{ $result->roll_no }}">
                                                                    <i data-feather="refresh-ccw" class="me-50"></i>
                                                                    <span>Update CGPA</span>
                                                                </a>
                                                    
                                                                <!-- Update Serial Number Link -->
                                                                <a class="dropdown-item" target="_blank"
                                                                    href="{{ url('ResultSerialNoUpdate') }}?roll_no={{ $result->roll_no }}">
                                                                    <i data-feather="refresh-ccw" class="me-50"></i>
                                                                    <span>Update Serial Number</span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
