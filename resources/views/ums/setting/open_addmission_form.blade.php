                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">  
                                     @if(Request()->type==1)
                                    Admission New Form Setting
                                    @else
                                    Admission Edit Form Setting
                                    @endif
                                </li>
                            </ol>
                        </div>
    ...
    {     
        var campus_id = $('#campus_id').val(); 
            ...
            { 
              ...
              $.ajax({ type:'POST',url:"{{route('get-courses-data')}}",
               data: {'_token': "<?php echo csrf_token() ?>",'campus_id' : campus_id,},
               success:function(data) { $("#course_id").html(data); }
             }); 
