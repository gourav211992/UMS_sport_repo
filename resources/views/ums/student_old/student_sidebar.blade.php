<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow erpnewsidemenu" data-scroll-to-active="true">
    ...
    <div class="main-menu-content newmodulleftmenu">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item">
                <a class="d-flex align-items-center" href="stu-dashboard">
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="{{url('exam-form')}}">
                    ...
                    <span class="menu-title text-truncate">Exam Forms</span>
                </a>
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="#">
                    ...
                    <span class="menu-title text-truncate">Semester Forms</span>
                </a>
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="#">
                    ...
                    <span class="menu-title text-truncate">Special Forms</span>
                </a>
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="#">
                    ...
                    <span class="menu-title text-truncate">Question Bank</span>
                </a>
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="#">
                    ...
                    <span class="menu-title text-truncate">Holiday Calender</span>
                </a>
            ...
            <!-- Holiday -->
            <li>
                <a class="d-flex align-items-center" href="{{ url('stu-profile') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                        <line x1="16" y1="13" x2="8" y2="13"></line>
                    ...
                    <span class="menu-item text-truncate">Personal Information</span>
                </a>
            </li>
        </ul>
    </div>
