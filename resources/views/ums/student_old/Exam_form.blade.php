...
<div class="row align-items-center">
	...
	@else
   		...
   		<h4>Please Select Your Papers Type Then Press Submit Button </h4><br>
		<br>
		<br>
   		<div class="row">
		...
		<div class="col-sm-4">
			...
			<select name="back_papers" id="back_papers" class="form-control" onchange="$('#form_data').submit()" style="border-color: #c0c0c0;" required>
                <option value="">--Select Papers--</option>
                    ...
                    <!-- <option value="back_paper" @if(Request()->back_papers=='back_paper') selected @endif>Back</option> -->
                    <option value="final_back_paper" @if(Request()->back_papers=='final_back_paper') selected @endif>Back / Final Back</option>
                    <!-- <option value="special_back" @if(Request()->back_papers=='special_back') selected @endif>Special Back</option> -->
			</select>
		</div>
