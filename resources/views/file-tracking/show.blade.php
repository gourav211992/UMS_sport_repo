                    ...
                    <div class="content-header-right text-end col-md-6 col-6 mb-2 mb-sm-0">
                        ...
                        <div class="form-group breadcrumb-right">
                            <a href="{{ route('file-tracking.index') }}"> <button class="btn btn-secondary btn-sm"><i
                                        ...
                                        @if($buttons['approve'])
                                        <button class="btn btn-success btn-sm mb-50 mb-sm-0" type="submit" id="sign-btn">
                                            <i data-feather="edit"></i> Signed
                                        </button>
                                        @endif
                        </div>
                    </div>
                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <form id="file-tracking-form" method="POST" action="{{ route('file-tracking.sign',$data->id) }}"
                                    ...
                                    <div class="card-body customernewsection-form">
                                        ...
                                        <div class="col-md-12">
                                            <div
                                                ...
                                                <div>
                                                    <h4 class="card-title text-theme">File Tracking Information</h4>
                                            ...
                                            <div class="border-bottom mb-2 pb-25">
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-select" name="book_id" id="book_id"
                                                                ...
                                                                <option value="" disabled
                                                                    {{ isset($data->book_id) ? '' : 'selected' }}>Select
                                                                </option>
                                                                @if ($series)
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control"
                                                                name="document_number" readonly id="document_number"
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                            ...
                                                            <div id="appenddata">
                                                                <div class="image-uplodasection">
                                                                    <div class="filepreview"><a
                                                                            href="{{ route('file-tracking.showFile', [$data->id]) }}"
                                                                            target="_blank"><i
                                                        ...
                                                        <div class="row align-items-center mb-1">
                                                            <div class="col-md-2">
                                                                <label class="form-label">Signed Document <span
                                                                        class="text-danger">*</span></label>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div id="appenddata">
                                                                    <div class="image-uplodasection">
                                                                        <div class="filepreview"><a
                                                                                href="{{ route('file-tracking.showSignFile', [$data->id]) }}"
                                                                                target="_blank"><i
                                                                                    data-feather="file"></i></a>
                                                                        </div>
                                                                        <!-- Preview images will be appended here -->
                                                        ...
                                                        <div class="row align-items-center mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    name="expected_completion_date" readonly
                                                                    id="expected_completion_date"
                                                                    value="{{ date('Y-m-d', strtotime($data->expected_completion_date)) }}"
                                                                    min="{{ date('Y-m-d') }}">
                                                        ...
                                                        <div class="row align-items-center mb-1" @if(!$buttons['approve']) hidden @endif>
                                                            <div class="col-md-2">
                                                                <label class="form-label">Remarks</label>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <textarea type="text" rows="4" class="form-control" @if($buttons['approve']) required @else readonly  @endif name="comments"
