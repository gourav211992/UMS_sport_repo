                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" id = "org_service_dropdown" placeholder="Select" class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" onclick="initializeAutocomplete('org_service_dropdown')">
