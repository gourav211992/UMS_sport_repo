                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input oninput="allowOnlyUppercase(event)" type="text" name="book_code" class="form-control" required
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <select
                                                                                    class="form-select mw-100 select2 organizations"
                                                                                    name="organization_id[]"
                                                                                    id="organization_id1" required>
                                                                                </select>
                                                                            </td>
                                                                            <td>
                                                                                <select class="form-select mw-100 series_numbering"
                                                                                    name="series_numbering[]"  required>
                                                                                    <option disabled selected
                                                                                        value="">Select
                                                                                    </option>
                                                                                    <option>Auto</option>
                                                                            ...
                                                                            <tr class="{{ $level }}">
                                                                                ...
                                                                                <td>
                                                                                    <select
                                                                                        ...
                                                                                        name="level_company_id[]" required>
                ...
                let newRow = `<tr>
                            ...
                            <div class="position-relative">
                                <select class="form-select mw-100 select2 companySelect" data-id="${rowCount + 1}"
                                    name="company_id[]" id="company_id${rowCount + 1}" required>
                            ...
                            <div class="position-relative">
                                <select class="form-select mw-100 select2 organizations"
                                    name="organization_id[]" id="organization_id${rowCount + 1}" required>
                                </select>
                            </div>
                            </td>
                            <td>
                            <div class="position-relative">
                                <select class="form-select mw-100 series_numbering" name="series_numbering[]" required>
                            ...
                            <td>
                            <div class="position-relative">
                                <select class="form-select mw-100" name="reset_pattern[]" required>
                                    <option disabled selected value="">Select</option>
                                    <option>Yearly</option>
                                    <option>Quarterly</option>
                                    <option>Monthly</option>
                ...
                function addLevelRow() {
                    ...
                    const newLevelRow = `
                        ...
                        <tr class="${levelCounter}">
                            ...
                            <td>
                                <select class="form-select mw-100 select2 levelCompanySelect" id = "company_select_${levelCounter}" data-id="${levelCounter}" name="level_company_id[]" required>
                                    <option disabled selected value="">Select Company</option>
                                    @foreach ($companies as $company)
                                        <option value="{{ $company->id }}">{{ $company->name }}</option>
                                    @endforeach
                            ...
                            <td>
                                <select class="form-select mw-100 select2 level_organizations" user-select-id = "${levelCounter - 1}_0" name="level_organization_id[]" id="level_organization_id${levelCounter}" required>
                                </select>
                            </td>
                                <td>
                            ...
                            <td>
                                <input type="text" value="0" name="min_value[]" required data-id="${levelCounter}" class="form-control mw-100 min-value">
                            </td>
                            <td class = "center-align-content">
                                <div class="customernewsection-form">
                                    <div class="demo-inline-spacing">
            ...
            <tr>
                ...
                <td>
                    <select class="form-select mw-100 select2 levelCompanySelect" id = "company_select_${level}"
                        data-id="${level}" name="level_company_id[]" required>
                        <option disabled selected value="">Select Company</option>
                        @foreach ($companies as $company)
                            <option value="{{ $company->id }}">{{ $company->name }}</option>
                        @endforeach
                ...
                <td>
                    <select class="form-select mw-100 select2 level_organizations" user-select-id = "${level-1}_0"
                        name="level_organization_id[]" id="level_organization_id${level}" required>
                    </select>
                </td>
              <td>
    <select class="form-select mw-100 select2 userSelect" data-id="${level}" name="user[${level - 1}][]" id = "user_select_${level-1}_0" required multiple>
        <option disabled value="">Select Approver</option>
         @foreach ($people as $user)
                ...
                <td>
                    <input type="text" value="0" name="min_value[]" required
