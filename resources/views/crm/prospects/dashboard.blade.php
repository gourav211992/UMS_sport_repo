                ...
                <div class="row match-height">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-success">{{ $prospectsData['salesFigureSum'] }}</h2>
                                    ...
                                    <div class="col-md-12 ">
                                        <table class="table border payrollconfigured customerdataapp">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-dark fw-bolder"><strong>{{isset($value->customer->company_name) ? $value->customer->company_name : '-'}}</strong></td>
                                                    <td><span
                    ...
                    <div class="col-md-6">
                        <div class="card overtimechart">
                            <div class="card-header newheader d-flex justify-content-between align-items-start">
                                <div class="header-left">
                                    <h4 class="card-title">Lost Prospects</h4>
                                </div>
                                <div class="dropdown d-flex align-items-center">
                                    <p class="mb-0 text-end font-small-2 me-1"><a class="mb-0 text-primary"
...
<script>
    ...
    // var diariesStatusCount = chartData.map(item => item.prospects_count);
    var diariesStatusCount = chartData
