...
<td><input type="number" class="form-control mw-100 text-end qty-input" maxAmount="{{$pi_item->balence_qty}}" value="{{$pi_item->balence_qty}}" name="components[{{$rowCount}}][qty]" step="any"></td>
