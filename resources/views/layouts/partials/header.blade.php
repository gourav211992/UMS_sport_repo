            ...
            <div class="header-navbar navbar-light navbar-shadow new-navbarfloating">
                <div class="navbar-container d-flex content">
                    ...
                    <ul class="nav navbar-nav align-items-center ms-auto">
                        <span class="avatar me-1"><span class="avatar"><a href="/dashboard"> UMS</a></span></span>
                        ...
                        @if (!empty($organizations) && count($organizations) > 0)
                            <li class="nav-item d-none d-lg-block select-organization-menu">
                                <form action="{{ route('update-organization') }}" method="POST">
                                    ...
                                    <select class="form-select" name="organization_id" id="organization"
                        ...
                        {{-- <span class="avatar"><span class="avatar"><a href="/dashboard"> UMS</a></span></span>
                        <div class="btn btn-outline-primary pb-1 pt-1 ps-1 pe-1"> <a href="/dashboard"> UMS</a></div> --}}
