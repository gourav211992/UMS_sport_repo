...
@section('title', 'Lease Create')

@section('content')
    <!-- BEGIN: Content-->
    <form action="{{ route('lease.store') }}" id="lease-form" method="POST" enctype="multipart/form-data">
        @csrf
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select" name="book_id"
                                                            onchange="getDocNumberByBookId()" id="series">
                                                            <option value="">Select</option>
                                                            @foreach ($book_type as $data)
                                                                <option value="{{ $data->id }}"
                                                                    {{ old('book_id') == $data->id ? 'selected' : '' }}>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="document_no"
                                                            id="document_no" value="{{ old('document_no') }}" readonly>
                                                        @error('document_no')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="hidden" name="exchage_rate" id="exchange_rate"
                                                                value="{{ old('exchage_rate') }}" />
                                                            <input type="text" class="form-control" readonly
                                                                id="exchange_rate_amount"
                                                                value="{{ old('exchage_rate_amount') }}" />
                                                    ...
                                                    <table
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr class="totalsubheadpodetail">
                                                                ...
                                                                <td class="text-end" id="total_lease_amount" readonly>0.00
                                                                </td>
                                                                <td class="text-end" id="total_other_charges" readonly>
                                                                    0.00</td>
                                                                <td class="text-end" id="total_plots_amount" readonly>0.00
                                                                </td>
                                                            </tr>
                                                            <tr valign="top">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-1">
                                                                                        ...
                                                                                        <input type="date"
                                                                                            ...
                                                                                            class="form-control"
                                                                                            value="{{ old('lease_start_date', date('Y-m-d')) }}"
                                                                                            required>
                                                                                    </div>
                                                                ...
                                                                <td colspan="3">
                                                                    <table class="table border mrnsummarynewsty">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end" id="othercharge">0.00
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="trbody" style="display:none"></tr>
                                                                        <tr class="totalsubheadpodetail">
                                                                            <td><strong>Taxable Value</strong></td>
                                                                            <td class="text-end" id="taxablevalue">0.00
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr class="totalsubheadpodetail">
                                                                            ...
                                                                            <td class="text-end" id="totalvalue">0.00</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr class="voucher-tab-foot">
                                                                            ...
                                                                            <td>
                                                                                <div
                                                                                    ...
                                                                                    <h5 id="installment_cost">0.00</h5>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                            ...
                            <table class="mt-1 table myrequesttablecbox table-striped po-order-detail custnewpo-detail">
                                ...
                                <tbody id="othercharges_body">
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control mw-100 othercharges-value"
                                                value=""></td>
                                        <td><button class="btn btn-danger btn-sm delete-row extradelete-row"><svg
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="2"></td>
                                        <td class="text-dark"><strong>Total</strong></td>
                                        <td class="text-dark" id="othercharges_total">0</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
        ...
        $(document).ready(function() {
            ...
            $('#addother_charges_row').on('click', function(e) {
                ...
                <tr>
                    ...
                    <td><button class="btn btn-danger btn-sm extradelete-row">
