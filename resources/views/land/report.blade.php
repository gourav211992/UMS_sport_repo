                                            ...
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                <select class="form-select select2" id="series">
                                                    ...
                                                    @foreach ($leases as $lease)
                                                        <option value="{{ $lease->id }}">{{ $lease->series }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                <select class="form-select select2" id="customer">
                                                    <option value="">Select</option>
                                                    @foreach ($leases as $lease)
                                                        <option value="{{ $lease->id }}">{{ $lease->customer }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                <select class="form-select" id="land_id">
                                                    ...
                                                    @foreach ($leases as $lease)
                                                        <option value="{{ $lease->id }}">{{ $lease->land_no }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="100px">Recovery Date</th>
                                            <th>Lease Amount</th>
