                                                            ...
                                                            <tbody>
                                                                @foreach ($recoveries as $recovery)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $recovery->due_date }}</td>
                                                                        <td>
                                                                            <span
                                                                                class="badge rounded-pill badge-light-{{ $recovery->land->status === 'active' ? 'warning' : ($recovery->land->status === 'inactive' ? 'danger' : 'success') }} badgeborder-radius">
                                                                                {{ ucfirst($recovery->land->status) }}
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <span
                    ...
                    fetch(window.routes.landGetRevenue)
                        ...
                        .then(data => {
                            ...
                            var donutChartConfigroletask = {
                                ...
                                series: [data.revenue, data.overdue, data
                                    .pending
