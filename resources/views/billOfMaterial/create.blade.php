                              ...
                              <div class="">
                                ...
                                <div class="row align-items-center mb-1">
                                 ...
                                 <div class="row align-items-center mb-1">
                                    ...
                                    <div class="col-md-5"> 
                                       <input type="hidden" id="head_uom_id" class="form-control" name="uom_id" readonly  />
                                 ...
                                 <table id="itemTable" class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                                    ...
                                    <tfoot>
                                       <tr class="totalsubheadpodetail">
                                          ...
                                          <td class="text-end" id="totalWasteAmtValue">0.00</td>
         ...
         <div class="modal-body px-sm-2 mx-50 pb-2">
            ...
            <div class="row">
               <div class="col-md-12 mb-1">
                  ...
                  <input type="number" step="any" name="waste_perc" class="form-control" placeholder="Enter Value">
               </div>
               <div class="col-md-12 mb-1">
                  <label class="form-label">Wastage Value <span class="text-danger">*</span></label>
                  <input type="number" step="any" name="waste_amount" class="form-control" placeholder="Enter Value">
               </div>
            </div>
         </div>
...
$(document).on('click', '.deleteOverHeadItem', (e) => {
   ...
   let tblRowCount = $(e.target).closest('a').attr('data-index');
   ...
   $(e.target).closest('tr').remove();
    ...
    tr.find('[name*="[overhead_amount]"]').val(totalOverheadAmount.toFixed(2));
    tr.find(`[name*="components[${rowCount}][overhead]"]`).remove();
    tr.find('[name*="[overhead_amount]"]').after(html);
