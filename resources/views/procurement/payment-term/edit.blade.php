                                                                ...
                                                                <tbody id="description-box">
                                                                    @forelse ($paymentTerm->details as $index => $detail)
                                                                        <tr data-id="{{ $detail->id }}" data-index="{{ $index }}">
                                                                           <input type="hidden" name="term_details[{{ $index }}][id]" value="{{ $detail->id }}">
                                                                            ...
                                                                            <td><input type="text" name="term_details[{{ $index }}][percent]" class="form-control percent mw-100 text-end" placeholder="Enter Percent" value="{{ number_format($detail->percent ?? 0, 2) }}" /></td> 
                                                                                <td>
                                                                    ...
                                                                    @empty
                                                                        <tr data-index="0">
                                                                            ...
                                                                            <td><input type="text" name="term_details[0][percent]" class="form-control percent mw-100 text-end " placeholder="Enter Percent" /></td>
...
$(document).ready(function() {
    ...
    function updateTermDaysVisibility() {
        $tableBody.find('tr').each(function() {
            ...
            } else if (triggerType === 'post delivery' || triggerType === 'pre delivery') {
                termDaysInput.prop('disabled', false);
            } else {
                termDaysInput.val('').prop('disabled', false);
            }
        });
    }
