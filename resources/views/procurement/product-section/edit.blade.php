                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="description" class="form-control" placeholder="Enter Description" value="{{ old('description', $productSection->description) }}" />
                                                        @error('description')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                        ...
                                                        <tbody id="details-box">
                                                            @forelse ($productSection->details as $key => $detail)
                                                                <tr data-id="{{ $detail->id }}">
                                                                    <td>{{ $key + 1 }}</td>
                                                                    <td>
                                                                        <input type="text" name="details[{{ $key }}][name]" class="form-control mw-100" placeholder="Enter Detail Name" value="{{ $detail->name }}" />
                                                                        @error("details.$key.name")
                                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                        @enderror
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="details[{{ $key }}][description]" class="form-control mw-100" placeholder="Enter Description" value="{{ $detail->description }}" />
