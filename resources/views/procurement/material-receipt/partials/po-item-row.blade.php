@foreach($poItems as $key => $item)
    ...
    <tr id="row_{{$rowCount}}" data-index="{{$rowCount}}" @if($rowCount < 2 ) class="trselected" @endif>
        ...
        <td>
            ...
            value="{{($item->order_qty - $item->grn_qty)}}" step="any" />
        </td>
        <td>
        ...
        <td>
            <input type="number" class="form-control mw-100 text-end rejected_qty" name="components[{{$rowCount}}][rejected_qty]" readonly value="0.00" step="any"/>
        </td>
        ...
        <td>
            <input type="text" placeholder="Select" class="form-control mw-100 ledgerselecct" name="store_section"/>
            <input type="hidden" name="components[{{$rowCount}}][store_id]">
            <input type="hidden" name="components[{{$rowCount}}][erp_store_code]">
        </td>
        <td>
            <div class="d-flex">
