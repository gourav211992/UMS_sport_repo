    ...
    <tr>
        <td class="poprod-decpt">
            <span class="badge rounded-pill badge-light-primary">
                <strong>MRN No.</strong>: {{$mrn->document_number}}
            </span>
            <span class="badge rounded-pill badge-light-primary">
                <strong>MRN Date.</strong>: {{date('Y-m-d', strtotime($mrn->document_date))}}
            </span>
        </td>
    </tr>
@endif
@if($poItem)
    <tr>
        <td class="poprod-decpt">
            <span class="badge rounded-pill badge-light-primary">
                <strong>PO No.</strong>: {{$poItem?->po?->document_number}}
            </span>
            <span class="badge rounded-pill badge-light-primary">
                <strong>PO Date.</strong>: {{date('Y-m-d', strtotime($poItem?->po?->document_date))}}
            </span>
        </td>
    </tr>
@endif
