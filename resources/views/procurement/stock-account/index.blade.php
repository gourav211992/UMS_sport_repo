                                                    ...
                                                    <tbody id="stockAccountsTable">
                                                        @if($stockAccount->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control autocomplete min-width category_name" name="stock_accounts[0][category_name]" placeholder="Search Category">
                                                                    <input type="hidden" name="stock_accounts[0][category_id]" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control autocomplete min-width sub_category_name" name="stock_accounts[0][sub_category_name]" placeholder="Search Sub Category">
                                                                    <input type="hidden" name="stock_accounts[0][sub_category_id]" />
                                                                </td>
                                                                <td>
                                                                    <select class="form-select select2" name="stock_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control autocomplete min-width ledger_name" name="stock_accounts[0][ledger_name]" placeholder="Search Ledger">
                                                                    <input type="hidden" name="stock_accounts[0][ledger_id]" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control autocomplete min-width ledger_group_name" name="stock_accounts[0][ledger_group_name]" placeholder="Search Ledger Group">
                                                                    <input type="hidden" name="stock_accounts[0][ledger_group_id]" />
                                                                </td>
                                                                <td>
                                                        ...
                                                        @else
                                                            @foreach($stockAccount as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control autocomplete min-width category_name" name="stock_accounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Search Category">
                                                                        <input type="hidden" name="stock_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control autocomplete min-width sub_category_name" name="stock_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Search Subcategory">
                                                                     ...
                                                                     <td> 
                                                                           <select class="form-select select2 item-select" name="stock_accounts[{{ $index }}][item_id][]" multiple>
                                                                                ...
                                                                                @if($subCategoryId && $item->category && $item->category->subCategories->where('id', $subCategoryId)->first())
                                                                                    ...
                                                                                    @endforeach
                                                                                {{-- If no subcategory selected, check category and items --}}
                                                                            ...
                                                                            <td>
                                                                                <input type="text" class="form-control autocomplete min-width ledger_name"  name="stock_accounts[{{ $index }}][ledger_name]"  value="{{ $item->ledger->name ?? '' }}" placeholder="Search Ledger">
                                                                                <input type="hidden" name="stock_accounts[{{ $index }}][ledger_id]" value="{{ $item->ledger_id ?? '' }}" />
                                                                            </td>

                                                                            <td>
                                                                                <input type="text" class="form-control autocomplete min-width ledger_group_name"  name="stock_accounts[{{ $index }}][ledger_group_name]"   value="{{ $item->ledgerGroup->name ?? '' }}" placeholder="Search Ledger Group"/> 
                                                                                <input type="hidden" name="stock_accounts[{{ $index }}][ledger_group_id]" value="{{ $item->ledger_group_id ?? '' }}" />
                                                                            </td>
        ...
        newRow.innerHTML = `
            ...
            <td class="organization-field">
             ...
             <td class="category-field">
                <input type="text" class="form-control autocomplete min-width category_name" name="stock_accounts[${rowIndex}][category_name]" placeholder="Search Category">
                <input type="hidden" name="stock_accounts[${rowIndex}][category_id]" />
            </td>
            <td class="sub-category-field">
                <input type="text" class="form-control autocomplete min-width sub_category_name" name="stock_accounts[${rowIndex}][sub_category_name]" placeholder="Search Subcategory">
                <input type="hidden" name="stock_accounts[${rowIndex}][sub_category_id]" />
            </td>
            <td class="item-field">
                <select class="form-select select2" name="stock_accounts[${rowIndex}][item_id][]" multiple>
                    <option value="">Select Item</option>
                </select>
            </td>
            <td class="book-field">
            ...
            <td class="ledger-field">
                <input type="text" class="form-control autocomplete min-width ledger_name" name="stock_accounts[${rowIndex}][ledger_name]" placeholder="Search Ledger">
                <input type="hidden" name="stock_accounts[${rowIndex}][ledger_id]" />
            </td>
             <td class="ledger-field">
                <input type="text" class="form-control autocomplete min-width ledger_group_name" name="stock_accounts[${rowIndex}][ledger_group_name]" placeholder="Search Ledger Group">
                <input type="hidden" name="stock_accounts[${rowIndex}][ledger_group_id]" />
            </td>
