                                                                ...
                                                                <tbody id="description-box">
                                                                    @forelse ($productSpecification->details as $index => $detail)
                                                                        ...
                                                                        <input type="hidden" name="specification_details[{{ $index }}][id]" value="{{ $detail->id }}">
                                                                            ...
                                                                            <td>
                                                                                <input type="text" name="specification_details[{{ $index }}][description]" class="form-control description mw-100" placeholder="Enter Description" value="{{ $detail->description ?? '' }}" />
                                                                            </td>
                                                                    ...
                                                                    @empty
                                                                        <tr data-index="0">
                                                                            ...
                                                                            <td>
                                                                                <input type="text" name="specification_details[0][name]" class="form-control name mw-100" placeholder="Enter Name" />
                                                                            </td>
                                                                            <td>
                                                                                <input type="text" name="specification_details[0][description]" class="form-control description mw-100" placeholder="Enter Description" />
                                                                            </td>
                                                                            <td>
                                                                                <a href="#" class="text-primary add-row"><i data-feather="plus-square"></i></a>
                                                                                <a href="#" class="text-danger delete-row"><i data-feather="trash-2"></i></a>
