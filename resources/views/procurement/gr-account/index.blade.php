                                                    ...
                                                    <tbody id="grAccountsTable">
                                                        @if($grAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete category_name" name="gr_accounts[0][category_name]" placeholder="Search Category">
                                                                    <input type="hidden" name="gr_accounts[0][category_id]" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete sub_category_name" name="gr_accounts[0][sub_category_name]" placeholder="Search Sub Category">
                                                                    <input type="hidden" name="gr_accounts[0][sub_category_id]" />
                                                                </td>
                                                                <td>
                                                                    <select class="form-select select2" name="gr_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete ledger_name" name="gr_accounts[0][ledger_name]" placeholder="Search Ledger">
                                                                    <input type="hidden" name="gr_accounts[0][ledger_id]" />
                                                                </td>
                                                               
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete ledger_group_name" name="gr_accounts[0][ledger_group_name]" placeholder="Search Ledger Group">
                                                                    <input type="hidden" name="gr_accounts[0][ledger_group_id]" />
                                                                </td>
                                                                <td>
                                                        ...
                                                        @foreach($grAccounts as $index => $item)
                                                            <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete category_name" name="gr_accounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Search Category">
                                                                    <input type="hidden" name="gr_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete sub_category_name" name="gr_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Search Subcategory">
                                                                ...
                                                                <!-- Ledger Select -->
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete ledger_name"  name="gr_accounts[{{ $index }}][ledger_name]"  value="{{ $item->ledger->name ?? '' }}" placeholder="Search Ledger">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control min-width autocomplete ledger_group_name"  name="gr_accounts[{{ $index }}][ledger_group_name]"   value="{{ $item->ledgerGroup->name ?? '' }}" placeholder="Search Ledger Group"/> 
                                                                    <input type="hidden" name="gr_accounts[{{ $index }}][ledger_group_id]" value="{{ $item->ledger_group_id ?? '' }}" />
                                                                </td>
    ...
    function addRow(clickedRow) {
        ...
        newRow.innerHTML = `
            ...
            <td class="category-field">
                <input type="text" class="form-control min-width autocomplete category_name" name="gr_accounts[${rowIndex}][category_name]" placeholder="Search Category">
                <input type="hidden" name="gr_accounts[${rowIndex}][category_id]" />
            </td>
            <td class="sub-category-field">
                <input type="text" class="form-control min-width autocomplete sub_category_name" name="gr_accounts[${rowIndex}][sub_category_name]" placeholder="Search Subcategory">
                <input type="hidden" name="gr_accounts[${rowIndex}][sub_category_id]" />
            </td>
            <td class="item-field">
                <select class="form-select select2" name="gr_accounts[${rowIndex}][item_id][]" multiple>
                    <option value="">Select Item</option>
                </select>
            </td>
            <td class="book-field">
            ...
            <td class="ledger-field">
                <input type="text" class="form-control min-width autocomplete ledger_name" name="gr_accounts[${rowIndex}][ledger_name]" placeholder="Search Ledger">
                <input type="hidden" name="gr_accounts[${rowIndex}][ledger_id]" />
            </td>
            <td class="ledger-field">
                <input type="text" class="form-control min-width autocomplete ledger_group_name" name="gr_accounts[${rowIndex}][ledger_group_name]" placeholder="Search Ledger Group">
                <input type="hidden" name="gr_accounts[${rowIndex}][ledger_group_id]" />
            </td>
            <td>
                <a href="#" class="text-primary me-50 add-row"><i data-feather="plus-square"></i></a>
                <a href="#" class="text-danger delete-row"><i data-feather="trash-2"></i></a>
