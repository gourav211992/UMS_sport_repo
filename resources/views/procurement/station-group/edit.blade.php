                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center mb-1">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="alias" class="form-control" value="{{ $stationGroup->alias ?? '' }}" placeholder="Enter Alias" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-center mb-1">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="name" class="form-control" value="{{ $stationGroup->name ?? '' }}" placeholder="Enter Station Group Name" required />
                                        </div>
                                    </div>
