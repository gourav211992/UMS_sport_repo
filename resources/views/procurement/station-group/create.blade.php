...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('station-groups.store') }}" data-redirect="{{ url('/station-groups') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Station Group</h2>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="alias" class="form-control" value="{{ old('alias') }}" placeholder="Enter Alias" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Enter Station Group Name" required />
                                            </div>
                                        </div>
