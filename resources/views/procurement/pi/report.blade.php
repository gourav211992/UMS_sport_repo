                                ...
                                <div class="row sortable">
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="po-no"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="po-date"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="item-code"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="po-qty"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="rec-qty"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="bal-qty"
                                                checked="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="po-amount">
                                    ...
                                    <div class="compoenentboxreport advanced-filterpopup customernewsection-form mb-1">
                                        ...
                                        <div class="row camparboxnewcen">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea maxlength="250" class="form-control" placeholder="Enter Remarks" name="remarks"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
