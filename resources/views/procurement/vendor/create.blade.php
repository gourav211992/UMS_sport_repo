                                                     ...
                                                     <div class="tab-pane active" id="payment">
                                                        ...
                                                        <div class="tab-pane" id="Shipping">
                                                            <div class="table-responsive"> 
                                                                <table class="mt-1 table myrequesttablecbox table-striped po-order-detail custnewpo-detail border" id="address"> 
                                                                    <thead>
                                                                        <tr>
                                                                            <th>S.No</th>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="row align-items-center mb-1">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="compliance[gstin_no]" class="form-control numberonly">
                                                                        </div>
                                                                    </div>
...
$(document).ready(function() {
    ...
    function addNewRow() {
        var $template = $bankTableBody.find('.bank-info-row:first').clone();
