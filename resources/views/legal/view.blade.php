                                                    ...
                                                    <div class="mail-body">
                                                        <div class="mail-details mb-0">
                                                            <div class="mail-items">
                                                                ...
                                                                <p class="mt-25 mb-0">By: @if(($msg->user_type == 1) &&!empty($msg->user)) {{ $msg->user->name }} @elseif(($msg->user_type == 2) &&!empty($msg->employee)) {{ $msg->employee->name }} @endif @if(count($msg->attachments) > 0) | View Replies <i data-feather="paperclip"></i>@endif</p>
                                                            </div>
                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        @if(!empty($team->user))
                                                          <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                                                   ...
                                                                   @else
                                                                    @php
                                                                        echo \App\Helpers\Helper::getInitials($team->user->name);
                                                                    @endphp
                                                                @endif
    ...
    if (detailsDiv) {
        ...
        replies.forEach(reply => {
             ...
             const dateObj1 = new Date(utcDate1);
                ...
                let userName = '';
                let useremail = '';
                if (reply.user_type == 1 && reply.user) {
                    userName = reply.user.name;
                     useremail = reply.user.email;
                } else if (reply.user_type == 2 && reply.employee) {
         ...
         const utcDate1 = msg.created_at; // Get the UTC date string
                ...
                let userName = '';
                let useremail = '';
                if (msg.user_type == 1 && msg.user) {
                    userName = msg.user.name;
                     useremail = msg.user.email;
                } else if (msg.user_type == 2 && msg.employee) {
