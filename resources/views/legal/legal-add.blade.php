                                        ...
                                        <div class="border-bottom mb-2 pb-25">
                                            <div class="row">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="requestno" readonly
                                ...
                                <select class="form-select" name="filter_land_no" id="filter_land_no">
                                    ...
                                    @if (isset($leases))
                                        @foreach ($leases as $key => $val)
                                            <option value="{{ $val->id }}">{{ $val->land->land_no }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
        ...
        $('#party_type').change(function() {
            ...
            if (partyType === 'Customer') {
                ...
                @foreach ($leases as $land)
                    landOptions += `<option value="{{ $land->id }}">{{ $land->land->land_no }}</option>`;
                @endforeach
                landOptions += `</select>`;
