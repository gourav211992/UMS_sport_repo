...
class ServiceParametersHelper
{
    ...
    const SERVICE_PARAMETERS_VALUES = [
        ...
        self::BOM_STATION_REQUIRED => self::BOM_SECTION_REQUIRED_VALUES,
        self::BOM_SUPERCEDE_COST_REQUIRED => self::BOM_SUPERCEDE_COST_REQUIRED_VALUES,
        self::BOM_COMPONENT_WASTE_REQUIRED => self::BOM_COMPONENT_OVERHEAD_REQUIRED_VALUES,
