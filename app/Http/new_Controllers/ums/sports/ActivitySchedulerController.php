...
if ($existing) {
    ...
    return back()->withErrors(['duplicate' => $errorMsg])->withInput();
        ...
        ActivityScheduler::create([
            ...
            'batch_year' => $validatedData['sportBatch'],
...
public function get_section_group(Request $request)
{
    ...
    if (is_numeric($sectionValue)) {
        $group = GroupMaster::where('section_id', $sectionValue)->get();
    } else {
        $group = GroupMaster::where('section_name', $sectionValue)->get();
    }
