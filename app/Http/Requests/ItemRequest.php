    ...
    public function rules(): array
    {
        ...
        return [
           ...
           'item_name' => [
            ...
            'cost_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0', 
            'sell_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0',
            'sub_types' => 'nullable|array',
            'sub_types.*' => 'integer|exists:erp_sub_types,id',
            'min_stocking_level' => 'nullable|integer|min:0',
            'max_stocking_level' => 'nullable|integer|min:0',
            'reorder_level' => 'nullable|integer|min:0',
            'minimum_order_qty' => 'nullable|integer|min:0',
            ...
            'alternate_uoms.*.cost_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0', 
            'alternate_uoms.*.sell_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0', 
            ...
            'approved_customer.*.sell_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0', 
            ...
            'approved_vendor.*.cost_price' => 'nullable|regex:/^[0-9]*(\.[0-9]+)?$/|min:0', 
