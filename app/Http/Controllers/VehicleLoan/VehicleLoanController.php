...
class VehicleLoanController extends Controller
{
    public function create(StoreVehicleLoanRequest $request)
    {
        ...
        return redirect("loan/index")->with('success', 'Vehicle Loan created/updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("loan/index")->with('success', 'Vehicle loan and related records deleted successfully.');
    }
}
