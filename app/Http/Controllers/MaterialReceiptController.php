...
class MaterialReceiptController extends Controller
{
    ...
    public function getItemDetail(Request $request)
    {
        ...
        $html = view('procurement.material-receipt.partials.comp-item-detail',compact('item','purchaseOrder', 'selectedAttr','remark','uomName','qty', 'totalStockData', 'checkStockStatus', 'checkApprovedQuantity', 'headerId', 'detailId','specifications'))->render();
    ...
    public function processPoItem(Request $request)
    {
        ...
        $html = view('procurement.material-receipt.partials.po-item-row', ['poItems' => $poItems])->render();
    ...
    private static function maintainStockLedger($mrn)
    {
        ...
        InventoryHelper::settlementOfInventoryAndStock($mrn->id, $detailIds, 'mrn', $mrn->document_status);
