...
class TermLoanController extends Controller
{
    public function create(StoreTermLoanRequest $request)
    {
        ...
        return redirect("loan/index")->with('success', 'Term Loan created/updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("loan/index")->with('success', 'Term Loan and related records deleted successfully.');
    }
}
