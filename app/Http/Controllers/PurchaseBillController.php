...
class PurchaseBillController extends Controller
{
    ...
    public function getItemDetail(Request $request)
    {
        ...
        $html = view('procurement.purchase-bill.partials.comp-item-detail', compact('item', 'mrn', 'selectedAttr', 'remark', 'uomName', 'qty', 'specifications', 'poItem'))->render();
        return response()->json(['data' => ['html' => $html], 'status' => 200, 'message' => 'fetched.']);
    }
    ...
    public function getMrn(Request $request)
    {
        ...
        $html = view('procurement.purchase-bill.partials.mrn-item-list', ['mrnItems' => $mrnItems])->render();
