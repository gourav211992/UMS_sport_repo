...
class PurchaseReturnController extends Controller
{
    ...
    public function addItemRow(Request $request)
    {
        ...
        $html = view('procurement.purchase-return.partials.item-row', compact(['rowCount', 'costCenters']))->render();
    ...
    public function getItemDetail(Request $request)
    {
        ...
        $html = view('procurement.purchase-return.partials.comp-item-detail', compact('item', 'mrn', 'selectedAttr', 'remark', 'uomName', 'qty', 'specifications', 'poItem'))->render();
        return response()->json(['data' => ['html' => $html], 'status' => 200, 'message' => 'fetched.']);
    }
    ...
    public function generatePdf(Request $request, $id)
    {
        ...
        $organizationAddress = Address::with(['city', 'state', 'country'])
            ...
            ->first();
        $purchaseBill = PRHeader::with(['vendor', 'currency', 'items', 'book', 'expenses'])
            ->findOrFail($id);
        ...
        return $pdf->stream('Purchase-Bill.pdf');
    }
    ...
    public function getMrn(Request $request)
    {
        ...
        $mrnItems = MrnDetail::where(function ($query) use ($seriesId, $applicableBookIds, $docNumber, $itemId, $vendorId) {
            $query->whereHas('item');
    ...
    public function processMrnItem(Request $request)
    {
        ...
        $html = view('procurement.purchase-return.partials.mrn-item-row', ['mrnItems' => $mrnItems, 'qtyTypeRequired' => $qtyTypeRequired])->render();
