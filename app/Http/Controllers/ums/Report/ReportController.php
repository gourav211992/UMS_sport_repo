...
class ReportController extends Controller
{
  ...
  public function tabulationChart(Request $request){
    ...
    if($campus_single){
      ...
      // Fetch batches (Add this line)
      $batches = Student::selectRaw("LEFT(roll_number, 4) as batch")->distinct()->pluck('batch');
    ...
    $data = [
      ...
      'batches' => $batches, // Pass batches to the view
  ];
    ...
    return view('ums.result.tabulation_chart', $data);
  }
