...
//	  dd($admit_card->examfee->subject);
    ...
    public function semesterResultBulk(Request $request)
    {
      ...
      return view('ums.result.semester_result_bulk',compact('students','campuses','courses','semesters' , 'sessions','course_id' ,'semester_id'));
    }
    ...
    $campuses = Campuse::whereIn('id',[6,23])->get();
		...
		return view('ums.result.nursing_result_bulk',compact('students','campuses','courses','semesters','sessions'));
	}
    ...
    public function allResults(Request $request)
{
    ...
    public function getSingleResult(Request $request,$roll_no)
    {
      ...
      ->get();
      return view('ums.result.edit_result',compact('results','grades','subjects','roll_no','semester'));
    }
    ...
    public function internal(Request $request)
    {
      ...
      return view('ums.result.internal_submit',compact('sessions','campuses','courses','semesters','course_id','semester_id','subjects','subject','examTypes'));
    }
