...
use App\Models\ums\ums_master\AcademicYear;
use App\Models\ums\ums_master\InstituteMapping;
...
class AcademicYearController extends Controller
{
    public function index()
    {
        ...
        return view('ums.ums_master.academic', compact('academicYears', 'institutes'));
    }

    public function create()
    {
        $institutes = InstituteMapping::all();
        return view('ums.ums_master.academic-add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('academic.index')->with('success', 'Academic Year added successfully!');
    }
...
public function edit($id)
{
    ...
    $institutes = InstituteMapping::all();
    return view('ums.ums_master.academic-edit', compact('year', 'institutes'));
}
...
public function show($id)
{
    $year = AcademicYear::findOrFail($id);
    $institutes = InstituteMapping::all();
    return view('ums.ums_master.academic-view', compact('year', 'institutes'));
}
