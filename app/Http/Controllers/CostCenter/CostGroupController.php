...
class CostGroupController extends Controller
{
    ...
    {
        $parentGroup = CostGroup::whereNotNull("parent_cost_group_id")->with([
            'parent' => function ($q) {
                $q->select('id', 'name');
            }
        ])->get();
    ...
    public function create()
    {
        ...
        $groups = CostGroup::orderBy('id', 'desc')->whereNotIn("id", $parent)->get();
    ...
    public function store(Request $request)
    {
        ...
        CostGroup::create(array_merge($request->all(), [
