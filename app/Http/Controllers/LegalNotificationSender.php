...
class LegalNotificationSender extends Controller
{
    ...
    public static function sendRequestAssignmentNotification(Employee $user, Legal $legal)
    {
    ...
    public static function sendNewCommentAddedNotification(Employee $user, Legal $legal)
    {
    ...
    public static function sendRequestResolvedNotification(Employee $user, Legal $legal)
    {
    ...
    public static function sendDocumentUploadNotification(Employee $user, Legal $legal)
    {
