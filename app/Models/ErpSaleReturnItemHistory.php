...
class ErpSaleReturnItemHistory extends Model
{
    ...
    {
        return $this -> belongsTo(ErpSaleReturnItemAttributeHistory::class, 'sr_item_id');
    }

    public function attributes()
    {
        return $this -> hasMany(ErpSaleReturnItemAttributeHistory::class, 'return_item_id');
    }
    ...
    public function item_attributes_array()
    {
        ...
        foreach ($itemAttributes as $attribute) {
            ...
            foreach ($attribute_ids as $attributeValue) {
                ...
                {
                    $isSelected = ErpSaleReturnItemAttributeHistory::where('return_item_id', $this -> getAttribute('id')) -> where('item_attribute_id', $attribute -> id) -> where('attribute_value', $attributeValueData -> value) -> first();
    ...
    {
        return $this -> hasMany(ErpSaleReturnTedHistory::class, 'return_item_id', 'id') -> where('ted_level', 'D') -> where('ted_type', 'Discount');
    }
    public function tax_ted()
    {
        return $this -> hasMany(ErpSaleReturnTedHistory::class, 'return_item_id', 'id') -> where('ted_level', 'D') -> where('ted_type', 'Tax');
    }
    public function item_locations()
    {
        return $this -> hasMany(ErpSaleReturnItemLocationHistory::class, 'invoice_item_id', 'id');
    }
    ...
    {
        return $this -> belongsTo(ErpSaleReturn::class, 'return_id');
    }
    ...
    {
        $tedRecords = ErpSaleReturnTedHistory::where('invoice_item_id', $this->id)
