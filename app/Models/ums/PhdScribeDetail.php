...
class PhdScribeDetail extends Model implements HasMedia
{
	use SoftDeletes, InteractsWithMedia;

    protected $table = 'phd_scribe_details';

	public function application() {
		return $this->hasOne(PhdApplication::class, 'id','phd_applications_id');
	}
