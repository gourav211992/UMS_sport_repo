...
class CourseSwitchingImport implements ToModel, WithValidation, WithHeadingRow, WithCalculatedFormulas
{
    ...
    {
        $courseSwitching = null; // Ensure variable is always initialized
            ...
            if (!$courseSwitching) {
                ...
                if ($student) {
                    ...
                    foreach ($old_semesters as $old_semester) {
                        ...
                        // Update all tables which have semester-wise data
                        if ($new_semester) {
                            DB::table('exam_fees')
                        ...
                        // Update tables that are not semester-specific
        ...
        return $courseSwitching; // This now always returns something (null if no switching occurs)
    }
