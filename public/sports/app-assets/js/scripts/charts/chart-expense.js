...
var donutChartElrole = document.querySelector('#donut-chartonrole'),
    donutChartConfigrole = {
      chart: {
        height: 350,
        type: 'donut'
      },
	...
	if (typeof donutChartElrole !== undefined && donutChartElrole !== null) {
		var donutChartrole = new ApexCharts(donutChartElrole, donutChartConfigrole);
		donutChartrole.render();
	  }
	...
	if (typeof donutChartElroletask !== undefined && donutChartElroletask !== null) {
		var donutChartroletask = new ApexCharts(donutChartElroletask, donutChartConfigroletask);
		donutChartroletask.render();
	  }
    
    
    var donutChartsourcecv = document.querySelector('#donut-soucecv'),
    donutChartConfigrolesoucv = {
      chart: {
        height: 400,
        type: 'donut'
      },
      ...
      labels: ['Consultant', 'LinkedIn', 'Career Page', 'Reference', 'Job site', 'Other site'],
      series: [3, 4, 8, 3, 4, 2],
      colors: [ '#BB205E', '#D9693D', '#6B12B7', '#B822DD', '#31A75C', '#00BBEA'
      ],
      dataLabels: {
        enabled: true,
        formatter: function (val) {
	...
	if (typeof donutChartsourcecv !== undefined && donutChartsourcecv !== null) {
		var donutChartroletaskcv = new ApexCharts(donutChartsourcecv, donutChartConfigrolesoucv);
		donutChartroletaskcv.render();
	  }
	
	
	
	var donutChartElroletaskapp = document.querySelector('#donut-apptask'),
    donutChartConfigroletaskapp = {
      chart: {
        height: 300,
        type: 'donut'
      },
	...
	if (typeof donutChartElroletaskapp !== undefined && donutChartElroletaskapp !== null) {
		var donutChartroletaskapp = new ApexCharts(donutChartElroletaskapp, donutChartConfigroletaskapp);
		donutChartroletaskapp.render();
	  }
