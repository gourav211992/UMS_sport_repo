...
$(function () {
  ...
  var radialBarChartEl = document.querySelector('#radialbar-chart'),
    radialBarChartConfig = {
      ...
      series: [80, 50, 35],
      labels: ['Scheduled', 'Pending', 'Closed']
    };
  ...
  if (typeof donutChartEl !== undefined && donutChartEl !== null) {
    ...
    donutChartConfig = {
      ...
      labels: ['Futuresleep', 'Ison Upholstery', 'Mondo Upholstery', 'Forte Healthcare', 'E9 Design', 'All Others'],
      series: [50, 85, 40, 50, 85, 40],
      colors: [
        chartColors.donut.series1,
...
var donutChartElrole = document.querySelector('#donut-chartonrole'),
	...
	var donutChartElroletask = document.querySelector('#donut-tdc'),
    donutChartConfigroletask = {
      chart: {
        height: 300,
        type: 'donut'
      ...
      labels: ['Gross Salary', 'Tax'],
      series: [2000000, 400000],
      colors: [ 
