...
$(window).on('load', function () {
  ...
  if (leavebarChartEx.length) {
    var leavebarChartExample = new Chart(leavebarChartEx, {
      ...
      data: {
        labels: ['Total Budget', 'Consumed', 'Remaining'],
        datasets: [
          {
            data: [15, 12, 5],
            barThickness: 25,
            backgroundColor: ['#00d4bd', '#EA5455', '#7367F0'],
...
if (assignedtaskChartEx.length) {
  ...
  if (barChartEx.length) {
    var barChartExample = new Chart(barChartEx, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [130, 110, 242, 444, 455, 554],
            barThickness: 25,
            backgroundColor: ['#6B12B7', '#6B12B7', '#6B12B7', '#6B12B7', '#6B12B7', '#6B12B7'],
            borderColor: 'transparent'
          }
        ]
      }
  ...
  if (horizontalBarChartEx.length) {
    new Chart(horizontalBarChartEx, {
      ...
      data: {
        labels: ['Sheelafoam', 'Staqo', 'Sleepwell'],
        datasets: [
          {
            data: [5, 4, 1],
            barThickness: 15,
