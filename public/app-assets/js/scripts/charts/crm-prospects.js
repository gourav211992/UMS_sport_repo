$(function () {
    ...
    var prospectsPipeline = {
        series: [
            {
                name: "",
                data: (typeof diariesStatusCount !== 'undefined' && diariesStatusCount !== null) ? diariesStatusCount : [],
            },
        ],
        chart: {
            type: 'bar',
    ...
    var donutChartProsp = document.querySelector('#donut-chart-prospects'),
        donutChartConfig = {
            ...
            labels: (typeof customerDiariesStatusTitle !== 'undefined' && customerDiariesStatusTitle !== null) ? customerDiariesStatusTitle : [],
            series: (typeof customerDiariesPercentage !== 'undefined' && customerDiariesPercentage !== null) ? customerDiariesPercentage : [],
            colors: (typeof customerDiariesColorCode !== 'undefined' && customerDiariesColorCode !== null) ? customerDiariesColorCode : [],
            dataLabels: {
                enabled: true,
                formatter: function (val, opt) {
                    return parseInt(val) + '%';
